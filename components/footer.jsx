...
const Footer = () => {
  return (
    <footer>
      ...
      <div className="mx-auto flex py-4  mx-8 bottom-0 left-0 right-0 justify-between items-center relative z-10">
        ...
        <Image src="/records.svg" alt="Records" width={30} height={30} />
      </div>
